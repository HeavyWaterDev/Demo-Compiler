...
_lr_productions = [
  ...
  ('statement -> NAME ASSIGN expression','statement',3,'p_statement_assign','parser.py',14),
  ('statement -> expression','statement',1,'p_statement_expr','parser.py',18),
  ('statement -> IF expression COLON statements END','statement',5,'p_statement_if','parser.py',22),
  ('statement -> LOOP expression COLON statements END','statement',5,'p_statement_loop','parser.py',26),
  ...
  ('expression -> expression EQ expression','expression',3,'p_expression_binop','parser.py',34),
  ('expression -> expression NE expression','expression',3,'p_expression_binop','parser.py',35),
  ('expression -> expression LT expression','expression',3,'p_expression_binop','parser.py',36),
  ('expression -> expression LE expression','expression',3,'p_expression_binop','parser.py',37),
  ('expression -> expression GT expression','expression',3,'p_expression_binop','parser.py',38),
  ('expression -> expression GE expression','expression',3,'p_expression_binop','parser.py',39),
  ...
  ('expression -> NAME','expression',1,'p_expression_name','parser.py',51),
]
